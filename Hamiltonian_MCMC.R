...
deriv(0.5, function(x) log(x))
deriv(2, function(x) 1/x^2)
...
#1.  Hamiltonian MCMC sampling function-------------------------------
...
#3. Sampling from Bimodal Normal Mixture --------------------------------------
# test HamMC function (Normal Mixture Bimodal)
...
#4. Plotting level plot(contour plot) -------------------------------------------------
